"use client";
import { t as require_react } from "./react-DuwXu_-K.js";
...
var s$1 = typeof window < `u` && window.document !== void 0, c$1 = new Uint8Array([
	...
	`w`,
	`h`
], u$1 = `0.74.0`, d$1 = `@lottiefiles/dotlottie-web`;
var f;
...
var o = ({ animationId: e, autoplay: t, backgroundColor: o, className: s, createDotLottie: c, data: l, dotLottieRefCallback: u, layout: d, loop: f, mode: p, playOnHover: m, renderConfig: h, segment: g, speed: _, src: v, stateMachineConfig: y, stateMachineId: b, style: x, themeData: S, themeId: C, useFrameInterpolation: w, workerId: T, ...E }) => {
	...
	...e,
	createDotLottie: s
}), l = (e) => new $(e), u = (e) => (0, import_jsx_runtime.jsx)(o, {
	...e,
	createDotLottie: l
}), d = (n) => {
	$.setWasmUrl(n), ae.setWasmUrl(n);
};
//#endregion
